...
function theme_register_scripts()
{
	...
	wp_enqueue_script('logovo-pagination', get_template_directory_uri() . '/assets/js/pagination.js', array('jquery'), $theme_version, false);
	wp_script_add_data('logovo-pagination', 'defer', true);
 ...
 * @return string $html
 */
function theme_get_custom_logo($html)
{
...
add_filter('get_custom_logo', 'theme_get_custom_logo');
 ...
 * @return string $html
 */
function theme_read_more_tag($html)
{
	return preg_replace('/<a(.*)>(.*)<\/a>/iU', sprintf('<div class="read-more-button-wrap"><a$1><span class="faux-button">$2</span> <span class="screen-reader-text">"%1$s"</span></a></div>', get_the_title(get_the_ID())), $html);
}

add_filter('the_content_more_link', 'theme_read_more_tag');
...
{
	echo '<a class="skip-link screen-reader-text" href="#site-content">' . __('Перейти к содержанию', 'twentytwenty') . '</a>';
}

add_action('wp_body_open', 'theme_skip_link', 5);
...
function theme_sidebar_registration()
{
	...
	register_sidebar(
		array_merge(
			...
			array(
				...
				'id'          => 'sidebar-footer',
				'description' => __('Widgets in this area will be displayed in the global footer.', 'twentytwenty'),
			)
		)
	);
	...
	register_sidebar(
		array_merge(
			$shared_args,
			array(
				'name'        => __('Post Footer', 'twentytwenty'),
				'id'          => 'sidebar-post-footer',
				'description' => __('Widgets in this area will be displayed after the blog post.', 'twentytwenty'),
			)
		)
	);
	...
	register_sidebar(
		array_merge(
			$shared_args,
			array(
				'name'        => __('Subscription Footer', 'twentytwenty'),
				'id'          => 'sidebar-footer-subscription',
				'description' => __('Widgets in this area will appear in the subscription footer section.', 'twentytwenty'),
			)
		)
	);
}
...
add_action('enqueue_block_editor_assets', 'theme_block_editor_styles', 1, 1);

/**
 * Enqueue classic editor styles.
 */
function theme_classic_editor_styles()
{
...
add_action('init', 'theme_classic_editor_styles');
 ...
 */
function theme_add_classic_editor_customizer_styles($mce_init)
{
...
add_filter('tiny_mce_before_init', 'theme_add_classic_editor_customizer_styles');
 ...
 * @return void
 */
function theme_customize_controls_enqueue_scripts()
{
	$theme_version = wp_get_theme()->get('Version');
...
add_action('customize_controls_enqueue_scripts', 'theme_customize_controls_enqueue_scripts');
 ...
 * @return void
 */
function theme_customize_preview_init()
{
	$theme_version = wp_get_theme()->get('Version');
...
add_action('customize_preview_init', 'theme_customize_preview_init');
	...
	$elements = array(
		'content'       => array(
			...
			'background' => array(
				...
				'background-color' => array(':root .has-background-background-color #site-content'),
			),
			'text'       => array(
		...
		'header-footer' => array(
			...
			'background' => array(
				...
				'background-color' => array('#site-header', '.footer-nav-widgets-wrapper', '#site-footer', '.menu-modal', '.menu-modal-inner', '.search-modal-inner', '.archive-header', '.singular .featured-media:before', '.wp-block-pullquote:before'),
			),
			'text'       => array(
			...
			'secondary'  => array(
				'color' => array('.site-description', 'body:not(.overlay-header) .toggle-inner .toggle-text', '.widget .post-date', '.widget .rss-date', '.widget_archive li', '.widget_categories li', '.widget cite', '.widget_pages li', '.widget_meta li', '.widget_nav_menu li', '.to-the-top', '.singular .entry-header .post-meta', '.singular:not(.overlay-header) .entry-header .post-meta a'),
			),
			'borders'    => array(
...
add_filter('init', 'wp_redefine_locale');
